# S2-LRU-16WAY, no-instrumentation control (2026-09-02) - identical eviction
...
new_sig = '''// S2-LRU-16WAY-NOATOMICS CONTROL VARIANT (2026-09-02) - same LRU eviction
// as s2_lru_patch.py, atomic hit/miss counters removed (wall-clock only).
static const size_t S2_NUM_SETS = 4096;
static const size_t S2_WAYS = 16;
...
new_lookup = '''            taxon = 0;
            if (! skip_lookup) {
              // S2-LRU-16WAY-NOATOMICS - same wiring, no counters.
