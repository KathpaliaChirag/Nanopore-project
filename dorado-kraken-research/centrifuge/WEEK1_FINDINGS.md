...
Full step-by-step command history lives in `commands_log.md`. Raw analysis and dead ends live in `observations.md`. This file is the readable summary of both.
