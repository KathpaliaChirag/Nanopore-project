...
Luna re-run (bare metal, Xeon Platinum 8468, AVX-512, accurate IPC and TMA): see `matmul_reports/matrix_multiplication/README.md`. That file contains:
...
GPU results (L40S, N=10000, 6 kernels): see `matmul_reports/matrix_multiplication/README.md`, section "GPU performance (L40S, N=10000)". Summary: cuBLAS tensor TF32 at 16.3 ms / 122,923 GFLOPS (6,900x vs WSL2 CPU best). Raw Luna profiling file: `Luna/profiling/results_matmul_luna.md`.
